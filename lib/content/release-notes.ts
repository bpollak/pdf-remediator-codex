...
export const RELEASE_NOTES: readonly ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      'Changed the default TritonAI OCR path to use the on-prem api-lightonocr-1b model first, with Mistral Small and Gemma fallbacks for production resilience.',
