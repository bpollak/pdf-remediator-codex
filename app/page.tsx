...
export default function LandingPage() {
  return (
    <section className="space-y-5 rounded-lg border-t-4 border-t-[var(--ucsd-blue)] bg-white px-10 py-12 shadow-md">
      <h1 className="text-3xl font-bold tracking-tight text-[var(--ucsd-navy)]">Make Your PDFs Accessible</h1>
      <p className="max-w-3xl text-lg leading-relaxed text-[var(--ucsd-blue)]">
        Audit PDFs against WCAG 2.1 AA and automatically fix accessibility issues — all in your browser.
      </p>
      <p className="max-w-3xl text-base leading-relaxed text-gray-600">
        Automated fixes cover document structure, tags, and metadata. Manual review is still recommended for full
        compliance.
      </p>
      <Link
        href="/app"
